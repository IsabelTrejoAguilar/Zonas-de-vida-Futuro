...
write.csv(alto.mexbio.estables45, "Resample/CNRMCM5_rcp45_2015_2039_bio/alto_mexbio_estables45.csv")
...
alto.mexbio.cambio45<-rbind(GP_cambio45.mexbio,DAN_cambio45.mexbio,
                       ...
                       SCH_cambio45.mexbio)
write.csv(alto.mexbio.cambio45, "Resample/CNRMCM5_rcp45_2015_2039_bio/alto_mexbio_cambio45.csv")